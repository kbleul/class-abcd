...
const Footer = () => {
    ...
    return (<>
        <article className="fotter_wrapper h-[90vh] overflow-hidden mt-[10vh] ">
            <section className="flex">
                <section className="w-4/5 ml-[10%] mt-16  relative">
                    ...
                    <div className="bg-gray-900 text-white p-2">
                        <h4 className="font-bold ml-[15%] text-xl">Address</h4>
        ...
        <section className="footer_nav-wrapper text-white flex justify-center items-center bg-black">
